 ...
 */
package co.uniandes.edu.ecos.utilidad;
...
public class Mapper {
     ...
     */
    public static <T extends Object> T copyCompleto(Object origenInstanciado, Class<T> claseDestino, boolean copiaRecursivaCollections) throws ClassNotFoundException {
